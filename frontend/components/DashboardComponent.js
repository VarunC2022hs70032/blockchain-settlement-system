...
export class DashboardComponent extends BaseComponent {
    ...
    setupStateSubscriptions() {
        ...
        this.unsubscribers.push(stateManager.subscribe('blockchain', (stats) => {
            this.queueUpdate('stats');
            this.updateStatsDisplay(stats);
        }));
        // Subscribe to user profile updates
        this.unsubscribers.push(stateManager.subscribe('user', (user) => {
            this.queueUpdate('profile');
            this.updateProfileDisplay(user);
        }));
        // Subscribe to connection status
        this.unsubscribers.push(stateManager.subscribe('blockchain', (stats, prev) => {
    ...
    bindEvents() {
        ...
        this.queryAll('.stat-card').forEach(card => {
            card.addEventListener('mouseenter', () => {
                this.animateStatHover(card, true);
            });
            card.addEventListener('mouseleave', () => {
                this.animateStatHover(card, false);
            });
        });
